import { aiPaperReportSchema, aiPlatformSchema, aiRecommendationsSchema, alertDeliveriesSchema, claimMonitorSchema, copyExecutionsSchema, copyPositionsSchema, copyTradeConfigMutationSchema, copyTradeConfigsSchema, copyTradeHealthSchema, feedConnectionsSchema, feedDiagnosticsSchema, heatmapSchema, holdersSchema, monitorAlertsSchema, narrativeSchema, ohlcvSchema, pairsSchema, portfolioAnalyticsSchema, riskSchema, signalsSchema, smartMoneySchema, swapQuoteSchema, tokenDetailSchema, topTradersSchema, transactionsSchema, trenchesSchema, trendingSchema, userAlertMutationSchema, userAlertsSchema, walletHoldingsSchema, walletPnlSchema, type AiPaperReport, type AiPlatform, type AiRecommendation, type AlertDeliveriesResponse, type ClaimMonitorResponse, type CopyExecution, type CopyPosition, type CopyTradeConfig, type CopyTradeHealth, type FeedConnectionsResponse, type FeedDiagnosticsResponse, type HeatmapResponse, type HoldersResponse, type MonitorAlertsResponse, type NarrativeResponse, type OhlcvResponse, type PairsResponse, type PortfolioAnalyticsResponse, type RiskResponse, type SignalsResponse, type SmartMoneyResponse, type SwapQuoteResponse, type TokenDetailResponse, type TopTradersResponse, type TransactionsResponse, type TrenchesResponse, type TrendingResponse, type UserAlert, type UserAlertsResponse, type WalletHoldingsResponse, type WalletPnlResponse } from './schema';
