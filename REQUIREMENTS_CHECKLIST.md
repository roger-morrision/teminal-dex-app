...
- [~] Component interaction coverage includes accessible token navigation/watchlist controls, Trenches quote handoff, alert financial-input gating, localized CopyTrade eligibility and AI advisory qualification, hostile input/privacy boundaries, localized exact-mint Signal handoff, distinct localized tracked-wallet and Snipe destructive intents, truthful localized Feed Data labels, localization persistence/interpolation/fallback, direct busy/error/empty/retry state coverage across primary markets, Monitor, Portfolio, Token Detail, quote review, Settings reset, AI, CopyTrade, market intelligence, wallet intelligence, Operations, and Research, and a static all-route Pressable/TextInput semantics gate; remaining one-off dynamic surfaces still require audit.
