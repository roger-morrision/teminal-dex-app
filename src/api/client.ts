import { aiPaperReportSchema, aiPlatformSchema, aiRecommendationsSchema, alertDeliveriesSchema, bubbleGraphSchema, claimMonitorSchema, copyExecutionsSchema, copyPositionsSchema, copyTradeConfigMutationSchema, copyTradeConfigsSchema, copyTradeHealthSchema, feedConnectionsSchema, feedDiagnosticsSchema, heatmapSchema, holdersSchema, manipulationSchema, monitorAlertsSchema, narrativeSchema, ohlcvSchema, pairsSchema, portfolioAnalyticsSchema, riskSchema, securityHistorySchema, signalsSchema, smartMoneySchema, snipersSchema, swapQuoteSchema, tokenDetailSchema, topTradersSchema, transactionsSchema, trenchesSchema, trendingSchema, userAlertMutationSchema, userAlertsSchema, walletHoldingsSchema, walletPnlSchema, type AiPaperReport, type AiPlatform, type AiRecommendation, type AlertDeliveriesResponse, type BubbleGraphResponse, type ClaimMonitorResponse, type CopyExecution, type CopyPosition, type CopyTradeConfig, type CopyTradeHealth, type FeedConnectionsResponse, type FeedDiagnosticsResponse, type HeatmapResponse, type HoldersResponse, type ManipulationResponse, type MonitorAlertsResponse, type NarrativeResponse, type OhlcvResponse, type PairsResponse, type PortfolioAnalyticsResponse, type RiskResponse, type SecurityHistoryResponse, type SignalsResponse, type SmartMoneyResponse, type SnipersResponse, type SwapQuoteResponse, type TokenDetailResponse, type TopTradersResponse, type TransactionsResponse, type TrenchesResponse, type TrendingResponse, type UserAlert, type UserAlertsResponse, type WalletHoldingsResponse, type WalletPnlResponse } from './schema';
