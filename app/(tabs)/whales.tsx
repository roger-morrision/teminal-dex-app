...
import { aggregateWhaleActivity, filterWhaleEvents, filterWhaleFlows, isWhaleActivity, whaleAmountContext, type WhaleEventDirection, type WhaleEventSort, type WhaleFlow } from "@/lib/whale-activity";
...
function WalletRankings({ rows, loading, refreshing, error, onRetry, onOpenAll, onOpen }: { rows: TopTrader[]; loading: boolean; refreshing: boolean; error?: string; onRetry: () => void; onOpenAll: () => void; onOpen: (address: string) => void }) {
  const { t } = useSettings();
