...
type TokenPanel = 'holders' | 'txns' | 'risk' | 'narrative' | 'smart-money' | 'pairs' | 'bubble' | 'manipulation';
type TokenPanelResponse = { holders: HoldersResponse; txns: TransactionsResponse; risk: RiskResponse; narrative: NarrativeResponse; 'smart-money': SmartMoneyResponse; pairs: PairsResponse; bubble: BubbleGraphResponse; manipulation: ManipulationResponse };
const panelSchemas = { holders: holdersSchema, txns: transactionsSchema, risk: riskSchema, narrative: narrativeSchema, 'smart-money': smartMoneySchema, pairs: pairsSchema, bubble: bubbleGraphSchema, manipulation: manipulationSchema } as const;
