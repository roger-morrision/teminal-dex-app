...
- [~] Token detail fetches normalized backend contracts for chart, holders, holder-cluster evidence, observed transactions, indexed transaction-behavior heuristics, risk/security evidence, smart money, narrative, and pairs with truthful limitations; swap execution remains incomplete.
