...
- [~] Settings provides persistent interpolation-safe English/Vietnamese strings, translated primary-tab headings/navigation/core states and full Settings safety copy, reduced-motion preference, telemetry consent default-off, and privacy reset. Auxiliary tool/detail screens and device screen-reader/dynamic-type verification remain incomplete.
