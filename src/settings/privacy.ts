...
export const LOCAL_DATA_KEYS = [SETTINGS_STORAGE_KEY, 'terminal-dex:watchlist:v1', 'terminal-dex:discovery-filters:v1', 'terminal-dex:watch-only-wallet:v1', TRACKED_WALLETS_KEY, RESEARCH_STORAGE_KEY, TRACK_FILTER_KEY] as const;
